...
learn = tabular_learner(dls, layers=[200,100], metrics=accuracy, # Dropout probabilities for each layer
                        cbs=[ShowGraphCallback()]) # Callback
...
learn.fit_one_cycle(5, lr_max=slice(1e-3)) # Adjust based on lr_find() results
